...
@Configuration
@ComponentScan(basePackages = "yohi1")
...
public class HibernateConfig {
    ...
    public EntityManagerFactory entityManagerFactory(DataSource dataSource) {
        ...
        entityManagerFactoryBean.setPackagesToScan(Objects.requireNonNull(environment.getProperty("package.toScan")));
